  ...
  return (
    <div className="w-full">
      <label className="relative block cursor-text">
        ...
        {type !== "datetime-local" && (
          <span
            className={`absolute top-0 left-0 px-4 text-sm  h-full flex items-center peer-focus:text-xs peer-focus:h-7 peer-valid:text-xs peer-valid:h-7 transition all ${
              value && "h-7 text-xs"
            }`}
          >
            {placeholder}
